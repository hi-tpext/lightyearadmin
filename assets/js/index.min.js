...
jQuery(function () {
    ...
    // 侧边栏导航
    $('.nav-item-has-subnav > a,a.open-tab').on('click', function () {
    ...
    // 设置主题配色
    setTheme = function (input_name, data_name, _default) {
        $("input[name='" + input_name + "']").click(function () {
            ...
            localStorage.setItem(input_name, val);
        });

        var val = localStorage.getItem(input_name) || _default;
        ...
        if (val) {
            ...
            $("input[name='" + input_name + "']").each(function (i, e) {
                if ($(e).val() == val) {
    ...
    setTheme('logo_bg', 'data-logobg', 'color_8');
    setTheme('header_bg', 'data-headerbg', 'color_8');
    setTheme('sidebar_bg', 'data-sidebarbg', 'color_8');
    setTheme('site_theme', 'data-theme', 'default');
